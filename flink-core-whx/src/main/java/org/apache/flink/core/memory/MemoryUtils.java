 ...
 * @description: 用于内存操作的实用程序类
 * @date 2021/8/2 9:04 下午
 */
@Internal
public final class MemoryUtils {
    ...
    private static long getClassFieldOffset(
            @SuppressWarnings("SameParameterValue") Class<?> cl,
            String fieldName
    ) {
        try {
            ...
            throw new Error(
                    getClassFieldOffsetErrorMessage(cl, fieldName) + ", unclassified error",
                    t
            );
        }
    }
